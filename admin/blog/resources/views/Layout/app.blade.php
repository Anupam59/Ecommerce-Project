...
<body class="fix-header fix-sidebar">
    ...
    <script src="{{asset('js/CategoryJs/category.js')}}"></script>
    <script src="{{asset('js/ContactJs/contact.js')}}"></script>
    ...
    <script src="{{asset('js/ReviewJs/review.js')}}"></script>
    <script src="{{asset('js/OrderListJs/orderList.js')}}"></script>
