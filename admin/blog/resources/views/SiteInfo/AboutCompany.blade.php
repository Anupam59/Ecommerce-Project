...
@section('content')
    ...
    <div class="container mt-5">
        ...
        <hr>
        <hr>
        <textarea id="AboutCompanyTextArea" class="SiteInfoTextArea"></textarea>
        <hr>
        <button id="AboutCompanyUpdateBtn" class="btn btn-brown">Edit And Update</button>
    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button data-id=" " id="AboutCompanyConfirmBtn" type="button" class="btn btn-sm btn-primary">Yes</button>
                </div>
            </div>
        </div>
    </div>
